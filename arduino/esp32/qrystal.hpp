...
public:
    ...
    // Pass by reference (const String&) to avoid memory copy
    static QRYSTAL_STATE heartbeat(const String &credentials)
    {
        ...
        // Fail Fast: Time Check (Optimized Lazy-Init)
        ...
        {
            // 5. Connection Lost: Auto-Recovery
